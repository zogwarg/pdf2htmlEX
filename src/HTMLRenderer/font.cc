...
void HTMLRenderer::export_remote_font(const FontInfo & info, const string & format, GfxFont * font)
{
    ...
    string tom_font_name = HTMLRenderer::TOM_exportFontName(font,info,format);
...
std::string HTMLRenderer::TOM_exportFontName(GfxFont * font, const FontInfo & info , const string & format)
{
    ...
    f_fonts.fs << CSS::FONT_FAMILY_CN << info.id << ":" << tom_name << ":" << fn << ":" << endl;
